...
public class AutomateSS {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //String testUrl = "https://www.alwayspackedstore.com/v1/coca-colaler/";
            InputStream is = AutomateSS.class.getClassLoader().getResourceAsStream("config.txt");
        	if (is == null) {
         ...
         // ================== Robots.txt ==================
			...
			/*
			 * String withoutProtocol = testUrl.replaceFirst("https?://", ""); String host =
			 * withoutProtocol.split("/")[0]; String domain =
			 * host.replaceAll("^(?:.*\\.)?([^.]+\\.com)$", "$1"); String testUrl1 =
			 * "https://www." + domain + "/robots.txt"; driver.get(testUrl1);
			 * Thread.sleep(2000); saveResult(driver, screenshotFolder, path,
			 * "05_robots.png", "5. Robots.txt Report Link");
			 */
            // ================== Domain Expiry ==================
          ...
          //  ((JavascriptExecutor) driver).executeScript("document.body.style.zoom='80%'");
			 ...
			 * driver.findElement(By.xpath("//input[@value='Submit']")).click(); new
			 * WebDriverWait(driver, Duration.ofSeconds(360))
			 * .until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(
			 * "//input[@name='d']"))); ((JavascriptExecutor)
			 * driver).executeScript("document.body.style.zoom='50%'"); Thread.sleep(1000);
			 * saveResult(driver, screenshotFolder, path, "07_ssllabs.png",
			 * "7. SSL Grade Report Link");
			 */
         // SSL Grade
            driver.get("https://www.ssllabs.com/ssltest");
            driver.findElement(By.xpath("//input[@name='d']")).sendKeys(testUrl);
            ...
            WebDriverWait wait_5 = new WebDriverWait(driver, Duration.ofSeconds(30));
            ...
            WebDriverWait wait_6 = new WebDriverWait(driver, Duration.ofSeconds(30));
            ...
            WebDriverWait wait_7 = new WebDriverWait(driver, Duration.ofSeconds(30));
         ...
         //   ((JavascriptExecutor) driver).executeScript("document.body.style.zoom='80%'");
          ...
          //===== Pr code start ================
            ...
            // Desktop tab
            WebDriverWait wait_8 = new WebDriverWait(driver, Duration.ofSeconds(30));
