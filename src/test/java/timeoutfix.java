...
public class timeoutfix {
    public static void main(String[] args) throws Exception {
        ...
        try {
            InputStream is = AutomateHL.class.getClassLoader().getResourceAsStream("config.txt");
            if (is == null) {
                throw new RuntimeException("config.txt not found!");
            }

            // Read all URLs line by line
            ...
            for (String testUrl : testUrls) {
                System.out.println("🚀 Running tests for: " + testUrl);

                String domainPart = testUrl.replaceFirst("^https?://", "").split("/")[0];
                domainPart = domainPart.replaceAll("[^a-zA-Z0-9.-]", "_");
                ...
                Thread.sleep(2000);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_01_http2.png", "1. HTTP2 Report Link");
                ...
                Thread.sleep(1000);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_02_https_redirection.png", "2. HTTPS Redirection Report Link");

                // ================== WhatsMyDNS ==================
                driver.get("https://www.whatsmydns.net/");

                String domainToTest = testUrl.replaceFirst("^https?://", "").split("/")[0];
                String urlWithWww = "www." + domainToTest.replaceFirst("^www\\.", "");
                String urlWithoutWww = domainToTest.replaceFirst("^www\\.", "");
                ...
                if (domainToTest.startsWith("www.")) {
                    ...
                    Thread.sleep(1000);
                    saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_03a_whatsmydns_www.png", "3a. Domain Test URL (with www)");
                    Thread.sleep(1000);
                    ...
                    ((JavascriptExecutor) driver).executeScript("document.body.style.zoom='50%'");
                    Thread.sleep(1000);
                    saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_03b_whatsmydns_nonwww.png", "3b. Domain Test URL (without www)");
                    Thread.sleep(1000);
                    ...
                    ((JavascriptExecutor) driver).executeScript("document.body.style.zoom='50%'");
                    Thread.sleep(1000);
                    saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_03_whatsmydns.png", "3. Domain Test URL Report Link");
                    Thread.sleep(1000);
                }
                ...
                Thread.sleep(1000);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_04_safe_browsing.png", "4. Safe Browsing Site Status Report Link");
                ...
                Thread.sleep(2000);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_05_robots.png", "5. Robots.txt Report Link");
                ...
                saveResult(driver, screenshotFolder, path,
                        siteIndex + "_" + domainPart + "_06_domain_expiry.png",
                ...
                ((JavascriptExecutor) driver).executeScript("document.body.style.zoom='80%'");
                Thread.sleep(1000);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_07_ssllabs.png", "7. SSL Grade Report Link");
                ...
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_08_pagespeed_mobile.png", "8. Google PageSpeed Mobile Report Link");
                ...
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_09_pagespeed_desktop.png", "9. Google PageSpeed Desktop Report Link");

                driver.get("https://validator.w3.org/nu/");
                driver.findElement(By.xpath("//input[@id='doc']")).sendKeys(testUrl);
                driver.findElement(By.xpath("//input[@id='submit']")).click();
                Thread.sleep(24);
                saveResult(driver, screenshotFolder, path, siteIndex + "_" + domainPart + "_10_HTML_Optimization.png", "10. HTML Optimisation Report Link");
